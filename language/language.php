<?php
	  ...
	  $client_lang['16'] = "Error in uploading mp4 file !!";
	  $client_lang['17'] = "Error in uploading mp3 file !!";
	  $client_lang['18'] = "Email is already exist !";
	  
	  $client_lang['invalid_email_format'] = "Invalid email format !!";
	  $client_lang['email_exist'] = "Email exist !!";
	  $client_lang['send_notification'] = "Send notification successfully...";
	  $client_lang['demo_mode'] = "This site is for demonstration purposes only, and no changes can be made...";
