...
if($searchInput != "")
{
    $query = "SELECT COUNT(*) as num  FROM tbl_playlist WHERE tbl_playlist.playlist_name LIKE '%$searchInput%'";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    <img type="image" src="images/thumbs/<?php _e($row['playlist_image']); ?>" class="image_size" />
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <?php if ($row['status'] != "0") { ?>
