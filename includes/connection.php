...
if ($_SERVER['HTTP_HOST'] == "localhost" or $_SERVER['HTTP_HOST'] == "192.168.1.29") {
	DEFINE('DB_USER', 'u351247987_flutter_audios');
	DEFINE('DB_PASSWORD', 'nAvof[?W&Bp5');
	DEFINE('DB_HOST', 'localhost');
	DEFINE('DB_NAME', 'u351247987_flutter_audios');
} else {
	DEFINE('DB_USER', 'u351247987_flutter_audios');
	DEFINE('DB_PASSWORD', 'nAvof[?W&Bp5');
	DEFINE('DB_HOST', 'localhost');
...
$site_url = "http://localhost/cc_flutter_audiobook/";
