                ...
                <div class="card">
                    <div class="card-body g-3"><br>
                        ...
                        <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div id="mp3_local_display" class="row col-12" <?php if ($count > 0 && $row['mp3_type'] != 'local') {
                                                                                echo 'style="display:none;"';
                                                                            } ?>>
                                ...
                                ?>
                                <input type="file" class="form-control" name="mp3_local" id="mp3_local" class="form-control" accept=".mp3">
                                <div class="col-12">
                                    <br><audio id="audio" src="<?php if ($count > 0 && $row['mp3_type'] == 'local') {
