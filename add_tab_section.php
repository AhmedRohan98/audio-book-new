...
if (isset($_POST['submit']) and isset($_GET['add'])  && PURCHASE == '') {
    ...
    $_SESSION['msg'] = "10";
    header("Location:home_tab_section.php");
    exit;
}
$count = 0;
if (isset($_GET['section_id'])) {
    $sql = "SELECT * FROM tbl_home_section where id='" . $_GET['section_id'] . "'";
...
if (isset($_POST['submit']) && isset($_POST['section_id'])  && PURCHASE == '') {
    ...
    $edit_id = Update('tbl_home_section', $data, "WHERE id = '" . $_POST['section_id'] . "'");
